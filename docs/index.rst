...
simulations are configured using `GSSA-XML <reference/gssa-xml>`_, a conceptual description
...
to container images) including Python/Numpy/`FEniCS <http://fenicsproject.org>`_ and
